...
%\makeatletter
%\preto\enditemize{\vspace{-\dimexpr\baselineskip+\topsep\relax}}
%\makeatother
...
\newcommand{\contactSpace}{\hspace{1.3cm}} % Missing closing curly bracket
...
\begin{document}
	\begin{resume_header}
		...
		\contact{\faPhoneSquare \hspace{\secsep} 07865076487 \contactSpace \href{mailto:meshwildias@gmail.com}{\faSend \hspace{\secsep}meshwildias@gmail.com} \contactSpace \href{https://github.com/02MESH}{\faGithub \hspace{\secsep}My GitHub} \contactSpace \href{https://www.linkedin.com/in/mad-0000/}{\faLinkedinSquare \hspace{\secsep}My LinkedIn}}
	\end{resume_header}

	%About Me
	\begin{resume_section}{About me}
		\begin{notabbedList}
			\textbf{Programming Languages \& OSs} \hspace*{5pt} \= C++/C, Python, Javascript \& NodeJS, Java, Linux, Windows\\*
			\textbf{Databases} \> MySQL, PostgreSQL, MongoDB, Mongoose\\*
			\textbf{Technologies \& Frameworks} \> HTML \& CSS, Bootstrap, EJS,  Express, Linux, \LaTeX\\*
			\textbf{Cloud Technologies} \> Docker, AWS, Azure, Kubernetes\\*
		\end{notabbedList}
	\end{resume_section}
	
	%Eduation
	\begin{resume_section}{Education}
		\begin{resume_subsection}{\href{https://www.kent.ac.uk/}{University of Kent}}{Canterbury, Kent}{Bachelor of Computer Science with Honours}{Sep 2021 - June 2024}
			\begin{subitems}
