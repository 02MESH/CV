...
\begin{document}
	...
	\begin{resume_section}{About me}
		\begin{notabbedList}
			\textbf{Programming Languages \& OSs} \hspace*{5pt} \= C++, Python, Javascript, Java, Windows, Linux \& Unix \\*
			\textbf{Databases} \> MySQL, PostgreSQL, MongoDB, Mongoose\\*
			\textbf{Technologies \& Frameworks} \> HTML, CSS, NodeJS, ReactJS, Bootstrap,  ExpressJS, \LaTeX\\*
